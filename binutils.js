module.exports = class BinaryReader {
    ...
    ReadUInt16 = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readUInt16LE(this.Position) : this.ByteBuffer.readUInt16BE(this.Position);
        this.Position += 2;
        return s_Val;
    }
    ...
    ReadUInt32 = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readUInt32LE(this.Position) : this.ByteBuffer.readUInt32BE(this.Position);
    ...
    ReadInt16 = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readInt16LE(this.Position) : this.ByteBuffer.readInt16BE(this.Position);
    ...
    ReadInt32 = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readInt32LE(this.Position) : this.ByteBuffer.readInt32BE(this.Position);
        this.ByteBuffer = this.ByteBuffer.slice(4);
        this.Position += 4;
        return s_Val;
    }
    ...
    ReadFloat = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readFloatLE(this.Position) : this.ByteBuffer.readFloatBE(this.Position);
        this.ByteBuffer = this.ByteBuffer.slice(4);
        this.Position += 4;
        return s_Val;
    }
    ...
    ReadDouble = function() {
        ...
        var s_Val = (this.Endianness === 'little') ? this.ByteBuffer.readDoubleLE(this.Position) : this.ByteBuffer.readDoubleBE(this.Position);
    ...
    ReadBytes = function(p_Count) {
        ...
        var s_Val = Buffer.from(this.ByteBuffer, this.Position, p_Count);
